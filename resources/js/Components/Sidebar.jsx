...
import { LogOut, User, Lock, FileText, ClipboardList } from 'lucide-react';
...
export default function Sidebar({ active }) {
    return (
        <div className="w-72 bg-[#2B5400] font-livvic text-white min-h-screen px-6 py-8 flex flex-col justify-between">
            ...
            {/* Logout */}
            <Link href="/logout" method="post" as="button" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-red-600/50">
